...
const PageContainer = ({ children }) => (
  <div className="page-container">
    ...
    <div className="footer">
      ...
      <div className="fb-share-button" data-href="https://gameofthronesintrocreator.kassellabs.io/" data-layout="button_count" data-size="small">
        <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fgameofthronesintrocreator.kassellabs.io%2F&amp;src=sdkpreparse" className="fb-xfbml-parse-ignore">Share</a>
      </div>
      <a href="https://twitter.com/share" className="twitter-share-button" data-text="Check out the Game Intro Creator from @KasselLabs!" data-url="https://gameofthronesintrocreator.kassellabs.io/" data-hashtags="GameOfThrones,KasselLabs">Tweet</a>
    </div>
  </div>
);
